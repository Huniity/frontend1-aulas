...
<div class="comment-section" style="margin-top: 20px">
    <input id="comment-input" type="text" style="margin-bottom: 7.5px; padding: 10px 0 10px 0; border: 0px solid #ccc; border-radius: 5px; " placeholder="Write your comment">
